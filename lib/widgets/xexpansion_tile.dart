...
/// [XExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [XExpansionTile].
///
/// {@tool dartpad}
...
class _XExpansionTileState extends State<XExpansionTile>
  ...
  void didChangeDependencies() {
    ...
    _borderColorTween.end = theme.dividerColor.withOpacity(0);
    _headerColorTween
