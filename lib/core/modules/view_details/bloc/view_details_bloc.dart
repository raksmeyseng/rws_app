...
class WaterSupplyViewDetailBloc
    extends Bloc<WaterSupplyViewDetailEvent, WaterSupplyViewDetailState> {
  ...
  Future<void> _onWaterSupplyViewDetailStarted(
    ...
    try {
      ...
      emit(state.copyWith(
          status: BaseStatusEnum.success, waterSupply: waterSupply));
    } catch (e) {
