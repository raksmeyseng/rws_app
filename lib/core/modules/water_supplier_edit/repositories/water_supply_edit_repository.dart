...
// submit data function
  ...
  Future<PayloadWellModel> addWaterSupplyWell(
      {required PayloadWellModel payload}) async {
...
// SmallPIPE--------------
  Future<PayloadSmallPipeModel> addWaterSupplySmallPipe(
      {required PayloadSmallPipeModel payload}) async {
...
//------------- Start KIOSK
  Future<PayloadKioskModel> addWaterSupplyKiosk(
      {required PayloadKioskModel payload}) async {
    final res = await post(ApiPath.postKiosk, data: payload);
    return PayloadKioskModel.fromJson(res);
  }

  Future<void> addWaterSupplyKioskOptionValue(
      {required PayloadKioskOptionValueModel payload}) async {
    try {
...
//------------- End KIOSK
//-------------Start Pond
  Future<PayloadPondModel> addWaterSupplyPond(
      {required PayloadPondModel payload}) async {
    final res = await post(ApiPath.postCommunityPond, data: payload);
    return PayloadPondModel.fromJson(res);
  }

  Future<void> addWaterSupplyPondOptionValue(
      {required PayloadPondOptionValueModel payload}) async {
...
//-------------Start Rain
  Future<PayloadRainModel> addWaterSupplyRain(
      {required PayloadRainModel payload}) async {
...
//------------- Start Pipe
  Future<PayloadPipeModel> addWaterSupplyPipe(
      {required PayloadPipeModel payload}) async {
    final res = await post(ApiPath.postPipe, data: payload);
    return PayloadPipeModel.fromJson(res);
  }

  Future<void> addWaterSupplyPipeOptionValue(
      {required PayloadPipeOptionValueModel payload}) async {
    await post(ApiPath.postPipeOptionValue, data: payload);
  }
//------------- End Pipe

//-------------Start Air
  Future<PayloadairModel> addWaterSupplyAir(
      {required PayloadairModel payload}) async {
    final res = await post(ApiPath.postAirWater, data: payload);
    return PayloadairModel.fromJson(res);
  }

  Future<void> addWaterSupplyAirOptionValue(
      {required PayloadairOptionValueModel payload}) async {
    await post(ApiPath.postAirWaterOptionValue, data: payload);
  }

//-------------End Air

  Future<void> addWaterSupplyQRCode(
      {required PayloadWaterSupplyQRCodeModel payload}) async {
