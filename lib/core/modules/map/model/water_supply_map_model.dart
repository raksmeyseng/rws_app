...
WaterSupplyMapModel _$WaterSupplyMapModelFromJson(Map<String, dynamic> json) =>
    WaterSupplyMapModel(
        id: json['id'] as int,
...
WaterSupplyMapModelV2 _$WaterSupplyMapModelV2FromJson(
...
class WaterSupplyCountByTypeModel {
  WaterSupplyCountByTypeModel({
    required this.count,
  });
  ...
  factory WaterSupplyCountByTypeModel.fromJson(Map<String, dynamic> json) =>
      _$WaterSupplyCountByTypeModelFromJson(json);
}

WaterSupplyCountByTypeModel _$WaterSupplyCountByTypeModelFromJson(
        Map<String, dynamic> json) =>
    WaterSupplyCountByTypeModel(count: json['count'] as int);
