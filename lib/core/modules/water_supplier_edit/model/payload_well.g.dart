...
PayloadWellOptionValueModel _$PayloadWellOptionValueModelFromJson(Map<String,dynamic> json)=>
...
Map<String,dynamic> _$PayloadWellOptionValueModelToJson(PayloadWellOptionValueModel instance)=>
<String,dynamic>{
