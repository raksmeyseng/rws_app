...
WaterSupplyRainModel _$WaterSupplyRainModelFromJson(
    ...
    WaterSupplyRainModel(
        ...
        capacityOfRainWaterHarvesting: (json['capacity_of_rain_water_harvesting_obj'] as List<dynamic>)
          .map((e) => WaterSupplyOptionValueModel.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$WaterSupplyRainModelToJson(
    ...
    <String, dynamic>{
            ...
            'water_quality_check_obj': instance.waterQualityCheckObj?.map((e) => e.toJson()).toList(),
            'capacity_of_rain_water_harvesting_obj': instance.capacityOfRainWaterHarvesting?.map((e) => e.toJson()).toList(),
