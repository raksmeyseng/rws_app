...
class WaterSupplyWellModel{
  ...
  factory WaterSupplyWellModel.fromJson(Map<String,dynamic> json)=> _$WaterSupplyWellModelFromJson(json);
...
factory WaterSupplyOptionModel.fromJson(Map<String,dynamic> json)=> _$WaterSupplyOptionModelFromJson(json);
...
class WaterSupplyOptionValueModel{
  ...
  factory WaterSupplyOptionValueModel.fromJson(Map<String,dynamic> json)=> _$WaterSupplyOptionValueModelFromJson(json);
